...
group :development do
  ...
  gem 'metadata-json-lint', '~> 0.0',       :require => false, :platforms => 'ruby'
  gem 'rspec-puppet-facts', '~> 1.3',       :require => false, :platforms => 'ruby'
  gem 'semantic_puppet', '0.1.3',           :require => false
  gem 'puppet-blacksmith', '>= 3.4.0',      :require => false, :platforms => 'ruby'
end

group :system_tests do
  gem 'beaker', '~> 2.16',      :require => false
  gem 'beaker-rspec', '~> 5.1', :require => false
